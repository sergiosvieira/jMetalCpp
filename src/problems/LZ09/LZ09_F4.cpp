 ...
 * Constructor
 */
LZ09_F4::LZ09_F4(std::string solutionType, int ptype, int dtype, int ltype)
{
    ...
    {
        std::cout << "LZ09_F4::LZ09_F4: Error reserving memory for storing the "
    ...
    {
        std::cout << "LZ09_F4::LZ09_F4: solution type " << solutionType << " invalid" << std::endl;
        exit(-1) ;
    }
