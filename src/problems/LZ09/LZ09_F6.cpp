 ...
 * Constructor
 */
LZ09_F6::LZ09_F6(std::string solutionType, int ptype, int dtype, int ltype)
{
    ...
    {
        std::cout << "LZ09_F6::LZ09_F6: Error reserving memory for storing the "
    ...
    {
        std::cout << "LZ09_F6::LZ09_F6: solution type " << solutionType << " invalid" << std::endl;
        exit(-1) ;
    }
...
void LZ09_F6::evaluate(ValuePtr solution)
{
