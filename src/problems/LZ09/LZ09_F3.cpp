 ...
 * Constructor
 */
LZ09_F3::LZ09_F3(std::string solutionType, int ptype, int dtype, int ltype)
{
    ...
    {
        std::cout << "LZ09_F3::LZ09_F3: Error reserving memory for storing the "
    ...
    {
        std::cout << "LZ09_F3::LZ09_F3: solution type " << solutionType << " invalid" << std::endl;
        exit(-1) ;
    }
...
void LZ09_F3::evaluate(ValuePtr solution)
{
