 ...
 * Constructor
 */
LZ09_F5::LZ09_F5(std::string solutionType, int ptype, int dtype, int ltype)
{
    ...
    {
        std::cout << "LZ09_F5::LZ09_F5: Error reserving memory for storing the "
    ...
    {
        std::cout << "LZ09_F5::LZ09_F5: solution type " << solutionType << " invalid" << std::endl;
        exit(-1) ;
    }
...
void LZ09_F5::evaluate(ValuePtr solution)
{
