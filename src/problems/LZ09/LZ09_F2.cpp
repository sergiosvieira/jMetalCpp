 ...
 * Constructor
 */
LZ09_F2::LZ09_F2(std::string solutionType, int ptype, int dtype, int ltype)
{
    ...
    {
        std::cout << "LZ09_F2::LZ09_F2: Error reserving memory for storing the "
    ...
    {
        std::cout << "LZ09_F2::LZ09_F2: solution type " << solutionType << " invalid" << std::endl;
        exit(-1) ;
    }
...
void LZ09_F2::evaluate(ValuePtr solution)
{
