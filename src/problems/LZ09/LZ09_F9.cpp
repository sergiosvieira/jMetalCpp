 ...
 * Constructor
 */
LZ09_F9::LZ09_F9(std::string solutionType, int ptype, int dtype, int ltype)
{
    ...
    {
        std::cout << "LZ09_F9::LZ09_F9: Error reserving memory for storing the "
    ...
    {
        std::cout << "LZ09_F9::LZ09_F9: solution type " << solutionType << " invalid" << std::endl;
        exit(-1) ;
    }
